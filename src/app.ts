...
class App {
    ...
    //  - Criando um método database que será responsavel por fazer a conexão com o mongo
    public async database() {
        try {
            // Estamos desabilitando a mensagem de depreciado para a strictQuery
            mongoose.set("strictQuery", true)
            //  - utilizando o mongoose e a função connect para conectar no nosso banco que está na nuvem
